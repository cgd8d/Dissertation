...
The previous section has described the calibration of the rotated energy spectrum.  In this section, we describe the measurement of energy resolution in this rotated energy measurement.
...
\small\normalsize
\begin{quote}
\caption{The residuals between calibrated and true peak positions for all sources is compared.  Calibrations were obtained from the $^{60}$Co and $^{232}$Th peaks at 1173, 1332, and 2615 keV.  Other calibration sources available were $^{137}$Cs and $^{226}$Ra at 662 and 2448 keV respectively.  Low-background calibration lines are neutron capture on hydrogen (2200 keV) and $^{40}$K (1461 keV).  Figure from~\cite{EnergyDocumentRun2ab}.}
