...
\tikzstyle{ParticleInteraction}=[circle]
\tikzstyle{ParticleLabel}=[]

\begin{figure}
% Generate figure. (in progress)
\begin{tikzpicture}
\node[ParticleLabel] (d1) {d};
\node[ParticleInteraction] (Strong1) [right of=d1] {};
\node[ParticleLabel] (u1) [right of=Strong1] {u};
\node[ParticleInteraction] (Weak1) [below of=Strong1] {};
\node[ParticleLabel] (e1) [right of=Weak1] {$e^{-}$};
...
\node[ParticleInteraction] (Strong2) [below of=Weak2] {};
\node[ParticleLabel] (u2) [right of=Strong2] {u};
