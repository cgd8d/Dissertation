...
\end{align}
In other words, if we presume that there is a Dirac neutrino mass similar to the masses of other leptons and a right-handed Majorana neutrino mass $m_R \gg m_D$, then in another basis a small left-handed Majorana neutrino mass $m_D^2/m_R$ is generated.  This is widely considered to be the most natural mechanism for a neutrino Majorana mass~\cite{RMPbb0n,mohapatra1998massive}.
...
Currently the leading experiments which are planned or currently searching for $\beta\beta 0\nu$ searches are:~\cite{RMPbb0n}
\begin{enumerate}
