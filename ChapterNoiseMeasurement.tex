...
Then in frequency space this is $n_i = A_i e^{\theta_i i}$.  (Similar for the negative frequency component; symmetry lets us ignore it.)
...
\begin{table}\label{tab:NoiseTimeWindows}
\begin{singlespace}
\begin{center}
...
2424-2690 & 9/30/2011-11/2/2011 & FEC voltage adjustment on 11/2/2011. \\\hline % Need to make supporting plot to show it matters.  Doesn't show in RMS plots from Josiah.
