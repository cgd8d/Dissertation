...
Similarly, it is hypothetically possible for neutrino absorption to stimulate a single-$\beta$ decay which would otherwise have been energetically forbidden; that isotope may then undergo a single-$\beta$ decay with a $Q$-value greater than the $Q$-value of the $\beta\beta 0\nu$ decay, acting as a background for $\beta\beta$ decay.  For example, in $^{136}$Xe the reaction $^{136}\mathrm{Xe} + \nu_e \rightarrow ^{136}\mathrm{Cs} + \mathrm{gammas}$ can occur; $^{136}$Cs can undergo single-$\beta$ decay with an endpoint energy of 2548 keV and halflife of 13.6 days.  This energy is above the $Q$-value for $^{136}$Xe $\beta\beta 0\nu$ decay.  However, this process is expected to occur at quite a low rate, and estimates indicate that it will be a negligible background until $^{136}$Xe sensitivities reach $T_{1/2}^{0\nu} = 10^{27}$ years~\cite{0954-3899-30-9-R01,1309.7957}.
...
\small\normalsize
\begin{quote}
\caption{Change in background rates expected in our $2\sigma$ region of interest as a function of the resolution.  Rates are normalized to one at a $Q$-value energy resolution of $1.6\%$ $\sigma/E$.  The three backgrounds shown, from $^{232}$Th, $^{238}$U, and $^{137}$Xe, are currently our dominant backgrounds.  We can see that backgrounds from $^{232}$Th increase sharply with resolutions worse than $2.8\%$ due to its $^{214}$Bi peak at 2615 keV and that it also shows a slight increase in backgrounds above $1.4\%$ due to inclusion of the compton edge at 2382 keV.  Rates from $^{238}$U are nearly constant until resolutions improve below $0.2\%$ due to the $^{214}$Bi line at 2448 keV.  $^{137}$Xe has a smooth spectrum near our $Q$-value, so its rates decrease quite smoothly as the resolution improves due to the shrinking region of interest.}
...
Figure~\ref{fig:BackgroundVsResolution} summarizes the background rates from our three dominant backgrounds, $^{232}$Th, $^{238}$U, and $^{137}$Xe, as they depend on the energy resolution of the detector.  We can see some of the features described above: the $^{238}$U contribution does not decrease substantially until extremely good resolutions below $0.2\%$ $\sigma/E$ are reached at our Q-value, due to the gamma line from $^{214}$Bi which is less than 10 keV from our $Q$-value.  By contrast, the backgrounds from $^{232}$Th decrease rapidly around $3\%$ due to separation from the $^{214}$Bi line at 2615 keV and, to a lesser degree, around $1.4\%$ due to separation from the compton edge of that gamma line.  Other backgrounds such as $^{137}$Xe are smooth in the region of interest and decrease linearly with resolution.  Thus, at the resolutions which are achieved for EXO-200 we can hope to reduce backgrounds from $^{232}$Th and $^{137}$Xe by improving the resolution; backgrounds from $^{238}$U can only be reduced by other means.  The following sections will identify some of the mechanisms used to further minimize these backgrounds.
